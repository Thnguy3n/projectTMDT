                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                        ...
                        <ul class="footer-menu-list tf-collapse-content">
                            ...
                            <li>
                                <a href="#" class="footer-menu_item"> Trả hàng + Đổi hàng </a>
                            </li>
                            <li>
                                <a href="#" class="footer-menu_item">Vận chuyển</a>
                            </li>
                            <li>
                                <a href="#" class="footer-menu_item">Điều khoản &amp; Điều
                                    kiện</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#" class="footer-menu_item">Danh sách mong muốn của tôi</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-xl-3 col-md-6 col-12 footer-col-block">
                        ...
                        <ul class="footer-menu-list tf-collapse-content">
                            <li>
                                <a href="#" class="footer-menu_item">Câu chuyện của chúng tôi</a>
                            </li>
                            <li>
                                <a href="#" class="footer-menu_item">Ghé thăm cửa hàng của chúng
                                    tôi</a>
                            </li>
                            <li>
                                <a href="#" class="footer-menu_item">Liên hệ với chúng tôi</a>
                            </li>
                            <li>
                                <a href="#" class="footer-menu_item">Tài khoản</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-xl-3 col-md-6 col-12">
